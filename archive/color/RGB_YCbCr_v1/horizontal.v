module horizontal(CLK,UP_CLKa,Hsync,hDE,RESET);
    ...
    begin
        ...
        begin
            ...
            if (H_COUNT < 10'd41) // 2 CLK (t_hb)
            begin    // Hsync 1
                hDE <= 1'b0;       // invalid data
            end
            else if ((H_COUNT >= 10'd41) && (H_COUNT <= 10'd520)) // 480 CLK (t_hd)
            begin   // Hsync 1
                hDE <= 1'b1;      // valid data
            end
            else if ((H_COUNT > 10'd520) && (H_COUNT <= 10'd524)) // 2 CLK (t_hf)
            begin    // Hsync 1
                hDE <= 1'b0;      // invalid data
            end
